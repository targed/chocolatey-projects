...
$packageArgs = @{
  ...
  fileType       = 'EXE' 
  url            = 'https://downloads.claude.ai/releases/win32/x64/1.30096.5/Claude-6e13464cbd9c3dc0501fe5ecb0568e3d3e9ea77a.exe'
  softwareName   = 'Claude*' 
  checksum       = '18358614E3162DD2AD5D4C2CF36BA7476AAA14BB5DA8002B58EC1322A72CA0B8'
  checksumType   = 'sha256'
