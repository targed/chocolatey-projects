...
$packageArgs = @{
  ...
  fileType       = 'EXE' 
  url            = 'https://downloads.claude.ai/releases/win32/x64/2.110.0/Claude-dfb2ba67b0820f5151bf7275ed57996f9d54d34c.exe'
  softwareName   = 'Claude*' 
  checksum       = '247996A550D308D7504B661074106BD84DE245223111A1A846A4106ADCCD5C4D'
  checksumType   = 'sha256'
