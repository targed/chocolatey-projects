...
$packageArgs = @{
  ...
  fileType       = 'EXE' 
  url            = 'https://downloads.claude.ai/releases/win32/x64/1.20186.7/Claude-b2b97146158c744569ac8dcf7bf85ddfa739192a.exe'
  softwareName   = 'Claude*' 
  checksum       = '1B871A3CEFA620997CF664C3B1F781F31391BD6AD37A9E3A87B7E06EC252D955'
  checksumType   = 'sha256'
