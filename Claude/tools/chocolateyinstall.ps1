...
$packageArgs = @{
  ...
  fileType       = 'EXE' 
  url            = 'https://downloads.claude.ai/releases/win32/x64/2.7032.0/Claude-6c468ab6ed862a68c9555cce34f11186c35f526d.exe'
  softwareName   = 'Claude*' 
  checksum       = '98123E628F751E45C180172669B41F92856D10B5EB6812A77CF00B778FCB6C59'
  checksumType   = 'sha256'
