...
$packageArgs = @{
  ...
  fileType       = 'EXE' 
  url            = 'https://downloads.claude.ai/releases/win32/x64/2.2553.0/Claude-177545b3e41a412735a8537afb925bb9ce9db6d3.exe'
  softwareName   = 'Claude*' 
  checksum       = 'E26154629BBDC9C758FFC1B94E8B76A78DCC179EEC25F1837C32600C8900C2B3'
  checksumType   = 'sha256'
