...
$packageArgs = @{
  ...
  fileType       = 'EXE' 
  url            = 'https://downloads.claude.ai/releases/win32/x64/1.28929.0/Claude-d1a6bcd4ef8627d603a8290548a984220b6701cf.exe'
  softwareName   = 'Claude*' 
  checksum       = 'B73C04ACB51D9F8ED7905EE2C267E19152AFD11A9478A8C15401A57117D25E89'
  checksumType   = 'sha256'
