...
$packageArgs = @{
  ...
  fileType       = 'EXE' 
  url            = 'https://downloads.claude.ai/releases/win32/x64/1.26832.0/Claude-056ee2be623b207f6a4d24dfb1b2fb5a82db0ecf.exe'
  softwareName   = 'Claude*' 
  checksum       = 'E98274FF9B6C972CD6C46814CAADB3C9F991439CB469E0F6E079D377DA95F614'
  checksumType   = 'sha256'
