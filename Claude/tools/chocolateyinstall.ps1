...
$packageArgs = @{
  ...
  fileType       = 'EXE' 
  url            = 'https://downloads.claude.ai/releases/win32/x64/1.20186.1/Claude-df1d8a339dfabcf359af7144fe142b59ff7d9a0f.exe'
  softwareName   = 'Claude*' 
  checksum       = '59A990A3632503F865AD58430B508B9170447487F6ED247C31CB7BF6563C2CBA'
  checksumType   = 'sha256'
