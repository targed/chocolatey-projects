...
$packageArgs = @{
  ...
  fileType       = 'EXE' 
  url            = 'https://downloads.claude.ai/releases/win32/x64/1.1.1520/Claude-48ced7a78a74c4c1b03d1dab181d1b0dc21d8fc8.exe'
  softwareName   = 'Claude*' 
  checksum       = 'CE2C04828C5B0283D0B5CBA81ED22F75FC3F5FF6DCA632D79BEEDDFE901BBDF9'
  checksumType   = 'sha256'
