...
$packageArgs = @{
  ...
  fileType       = 'EXE' 
  url            = 'https://downloads.claude.ai/releases/win32/x64/1.22209.0/Claude-77c938bac27689d6df971289c10759e512785c73.exe'
  softwareName   = 'Claude*' 
  checksum       = 'F53E817530812FE86FC953C3BB20147F129A2E36592EC69BB90C49A9B3A6C80E'
  checksumType   = 'sha256'
