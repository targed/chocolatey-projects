...
$packageArgs = @{
  ...
  fileType       = 'EXE' 
  url            = 'https://downloads.claude.ai/releases/win32/x64/1.21459.1/Claude-85cb5c02268829ab7605f76dfa13a4217159ca9f.exe'
  softwareName   = 'Claude*' 
  checksum       = '9DAAAB7FF988C133FD3142E443C45216D88CA6F6A7BC9ABB635D16CCB174AFF3'
  checksumType   = 'sha256'
