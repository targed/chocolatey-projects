...
$packageArgs = @{
  ...
  fileType       = 'EXE' 
  url            = 'https://downloads.claude.ai/releases/win32/x64/1.19367.0/Claude-1a5be1fbf83d1832486e03a667557c18f0a0ec7a.exe'
  softwareName   = 'Claude*' 
  checksum       = 'C0ED59AF963D0C73F1C6911E474EDB9368D984B5015B3614A8CAAB4674D277E7'
  checksumType   = 'sha256'
