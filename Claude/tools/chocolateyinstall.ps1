...
$packageArgs = @{
  ...
  fileType       = 'EXE' 
  url            = 'https://downloads.claude.ai/releases/win32/x64/2.2553.1/Claude-c38127e27202ddc1c8c187102f7798a93b1b8ede.exe'
  softwareName   = 'Claude*' 
  checksum       = '99DCB409F3CF381F1E8D2DED3C7ECF685D9981AABCB9D52EBCAE565574A00D4A'
  checksumType   = 'sha256'
